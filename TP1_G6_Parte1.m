function varargout = TP1_G6_Parte1(varargin)
% TP1_G6_PARTE1 MATLAB code for TP1_G6_Parte1.fig
%      TP1_G6_PARTE1, by itself, creates a new TP1_G6_PARTE1 or raises the existing
%      singleton*.
%
%      H = TP1_G6_PARTE1 returns the handle to a new TP1_G6_PARTE1 or the handle to
%      the existing singleton*.
%
%      TP1_G6_PARTE1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in TP1_G6_PARTE1.M with the given input arguments.
%
%      TP1_G6_PARTE1('Property','Value',...) creates a new TP1_G6_PARTE1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before TP1_G6_Parte1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to TP1_G6_Parte1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help TP1_G6_Parte1

% Last Modified by GUIDE v2.5 30-Sep-2020 14:22:21

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @TP1_G6_Parte1_OpeningFcn, ...
                   'gui_OutputFcn',  @TP1_G6_Parte1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before TP1_G6_Parte1 is made visible.
function TP1_G6_Parte1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to TP1_G6_Parte1 (see VARARGIN)

% Choose default command line output for TP1_G6_Parte1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes TP1_G6_Parte1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = TP1_G6_Parte1_OutputFcn(hObject, eventdata, handles) 
